...
type Botprofilecaptchabinding struct {
	...
	*/
	Waittime uint32 `json:"waittime,omitempty"`
	/**
	...
	*/
	Muteperiod uint32 `json:"muteperiod,omitempty"`
	/**
	...
	*/
	Requestsizelimit uint32 `json:"requestsizelimit,omitempty"`
	/**
	* Number of times client can retry solving the captcha.
	*/
	Retryattempts uint32 `json:"retryattempts,omitempty"`
	/**
