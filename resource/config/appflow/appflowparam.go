...
type Appflowparam struct {
	...
	*/
	Templaterefresh uint64 `json:"templaterefresh,omitempty"`
	/**
	...
	*/
	Appnamerefresh uint64 `json:"appnamerefresh,omitempty"`
	/**
	* Interval, in seconds, at which to send flow records to the configured collectors.
	*/
	Flowrecordinterval uint64 `json:"flowrecordinterval,omitempty"`
	/**
	* Interval, in seconds, at which to send security insight flow records to the configured collectors.
	*/
	Securityinsightrecordinterval uint64 `json:"securityinsightrecordinterval,omitempty"`
	/**
	* MTU, in bytes, for IPFIX UDP packets.
	*/
	Udppmtu uint32 `json:"udppmtu,omitempty"`
	/**
	...
	*/
	Usagerecordinterval uint64 `json:"usagerecordinterval,omitempty"`
	/**
	...
	*/
	Observationpointid uint32 `json:"observationpointid,omitempty"`
	/**
	...
	*/
	Disttracingsamplingrate uint32 `json:"disttracingsamplingrate,omitempty"`
	/**
	...
	*/
	Tcpattackcounterinterval uint64 `json:"tcpattackcounterinterval,omitempty"`
	/**
