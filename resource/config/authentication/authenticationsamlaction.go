...
type Authenticationsamlaction struct {
	...
	*/
	Samlacsindex uint32 `json:"samlacsindex,omitempty"`
	/**
	...
	*/
	Attributeconsumingserviceindex uint32 `json:"attributeconsumingserviceindex,omitempty"`
	/**
	...
	*/
	Metadatarefreshinterval uint32 `json:"metadatarefreshinterval,omitempty"`
	/**
