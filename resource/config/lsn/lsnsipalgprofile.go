...
type Lsnsipalgprofile struct {
	...
	*/
	Datasessionidletimeout uint32 `json:"datasessionidletimeout,omitempty"`
	/**
	* SIP control channel session timeout in seconds.
	*/
	Sipsessiontimeout uint32 `json:"sipsessiontimeout,omitempty"`
	/**
	* SIP registration timeout in seconds.
	*/
	Registrationtimeout uint32 `json:"registrationtimeout,omitempty"`
	/**
