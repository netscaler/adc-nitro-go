...
type Lsntransportprofile struct {
	...
	*/
	Finrsttimeout uint64 `json:"finrsttimeout,omitempty"`
	/**
	* STUN protocol timeout
	*/
	Stuntimeout uint32 `json:"stuntimeout,omitempty"`
	/**
	* SYN Idle timeout
	*/
	Synidletimeout uint32 `json:"synidletimeout,omitempty"`
	/**
	...
	*/
	Portquota uint32 `json:"portquota,omitempty"`
	/**
	...
	*/
	Sessionquota uint32 `json:"sessionquota,omitempty"`
	/**
	...
	*/
	Groupsessionlimit uint64 `json:"groupsessionlimit,omitempty"`
	/**
