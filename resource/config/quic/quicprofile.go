...
type Quicprofile struct {
	...
	*/
	Ackdelayexponent uint32 `json:"ackdelayexponent,omitempty"`
	/**
	...
	*/
	Activeconnectionidlimit uint32 `json:"activeconnectionidlimit,omitempty"`
	/**
	...
	*/
	Initialmaxdata uint32 `json:"initialmaxdata,omitempty"`
	/**
	...
	*/
	Initialmaxstreamdatabidilocal uint32 `json:"initialmaxstreamdatabidilocal,omitempty"`
	/**
	...
	*/
	Initialmaxstreamdatabidiremote uint32 `json:"initialmaxstreamdatabidiremote,omitempty"`
	/**
	...
	*/
	Initialmaxstreamdatauni uint32 `json:"initialmaxstreamdatauni,omitempty"`
	/**
	...
	*/
	Initialmaxstreamsbidi uint32 `json:"initialmaxstreamsbidi,omitempty"`
	/**
	...
	*/
	Initialmaxstreamsuni uint32 `json:"initialmaxstreamsuni,omitempty"`
	/**
	...
	*/
	Maxackdelay uint32 `json:"maxackdelay,omitempty"`
	/**
	...
	*/
	Maxidletimeout uint32 `json:"maxidletimeout,omitempty"`
	/**
	...
	*/
	Maxudpdatagramsperburst uint32 `json:"maxudpdatagramsperburst,omitempty"`
	/**
	...
	*/
	Maxudppayloadsize uint32 `json:"maxudppayloadsize,omitempty"`
	/**
	...
	*/
	Newtokenvalidityperiod uint32 `json:"newtokenvalidityperiod,omitempty"`
	/**
	...
	*/
	Retrytokenvalidityperiod uint32 `json:"retrytokenvalidityperiod,omitempty"`
	/**
