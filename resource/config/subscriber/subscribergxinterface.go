...
type Subscribergxinterface struct {
	...
	*/
	Idlettl uint32 `json:"idlettl,omitempty"`
	/**
	* q!Revalidation Timeout, in seconds, after which the Gx CCR-U request will be sent after any PCRF activity on a session. Any RAR or CCA message resets the timer.
		Zero value disables the idle timeout. !
	*/
	Revalidationtimeout uint32 `json:"revalidationtimeout,omitempty"`
	/**
	...
	*/
	Healthcheckttl uint32 `json:"healthcheckttl,omitempty"`
	/**
	...
	*/
	Cerrequesttimeout uint32 `json:"cerrequesttimeout,omitempty"`
	/**
	...
	*/
	Servicepathavp []uint32 `json:"servicepathavp,omitempty"`
	/**
	*  The vendorid of the AVP in which PCRF sends service path for subscriber.
	*/
	Servicepathvendorid uint32 `json:"servicepathvendorid,omitempty"`
	/**
