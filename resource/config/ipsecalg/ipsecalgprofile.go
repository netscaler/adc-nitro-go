...
type Ipsecalgprofile struct {
	...
	*/
	Ikesessiontimeout uint32 `json:"ikesessiontimeout,omitempty"`
	/**
	* ESP session timeout in minutes.
	*/
	Espsessiontimeout uint32 `json:"espsessiontimeout,omitempty"`
	/**
	* Timeout ESP in seconds as no ESP packets are seen after IKE negotiation
	*/
	Espgatetimeout uint32 `json:"espgatetimeout,omitempty"`
	/**
