...
/**
* Binding class showing the binding that can be bound to denylistglobal.
*/
type Denylistglobalbindingbinding struct {
	/**
	...
	*/
	...
	/**
	* Restore the all option settings of binding to default values.
	*/
	Restoredefaults bool `json:"restoredefaults,omitempty"`
