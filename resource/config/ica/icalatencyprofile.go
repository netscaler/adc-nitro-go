...
type Icalatencyprofile struct {
	...
	*/
	L7latencythresholdfactor uint32 `json:"l7latencythresholdfactor,omitempty"`
	/**
	...
	*/
	L7latencywaittime uint32 `json:"l7latencywaittime,omitempty"`
	/**
	...
	*/
	L7latencynotifyinterval uint32 `json:"l7latencynotifyinterval,omitempty"`
	/**
	...
	*/
	L7latencymaxnotifycount uint32 `json:"l7latencymaxnotifycount,omitempty"`
