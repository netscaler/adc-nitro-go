...
type Ipsecprofile struct {
	...
	*/
	Livenesscheckinterval uint32 `json:"livenesscheckinterval,omitempty"`
	/**
	* IPSec Replay window size for the data traffic
	*/
	Replaywindowsize uint32 `json:"replaywindowsize,omitempty"`
	/**
	* IKE retry interval for bringing up the connection
	*/
	Ikeretryinterval uint32 `json:"ikeretryinterval,omitempty"`
	/**
	...
	*/
	Retransmissiontime uint32 `json:"retransmissiontime,omitempty"`
	/**
	* Enable/Disable PFS.
	*/
