...
type Streamidentifier struct {
	...
	*/
	Maxtransactionthreshold uint32 `json:"maxtransactionthreshold,omitempty"`
	/**
	* Minimum per transcation value of metric. Metric to be tracked is specified by tracktransactions attribute.
	*/
	Mintransactionthreshold uint32 `json:"mintransactionthreshold,omitempty"`
	/**
	...
	*/
	Breachthreshold uint32 `json:"breachthreshold,omitempty"`
