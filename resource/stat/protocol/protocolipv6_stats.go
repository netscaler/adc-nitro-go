...
type Protocolipv6stats struct {
	...
	*/
	Ipv6fragpktsprocessnoreassrate int32 `json:"ipv6fragpktsprocessnoreassrate,omitempty"`
	...
	*/
	Ipv6fragpktsforwardrate int32 `json:"ipv6fragpktsforwardrate,omitempty"`
