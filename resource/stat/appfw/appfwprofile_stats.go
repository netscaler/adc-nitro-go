...
type Appfwprofilestats struct {
	...
	*/
	...
	Appfirewallviolsqlcombinedperprofile int `json:"appfirewallviolsqlcombinedperprofile,omitempty"`
	/**
	* Number of Combined SQL Injection security check violations seen by the Application Firewall.
	*/
	Appfirewallviolsqlcombinedperprofilerate float64 `json:"appfirewallviolsqlcombinedperprofilerate,omitempty"`
	Appfirewallviolcombinedxxeperprofile int `json:"appfirewallviolcombinedxxeperprofile,omitempty"`
	/**
	* Number of combined XXE security check violations seen by the Application Firewall.
	*/
	Appfirewallviolcombinedxxeperprofilerate float64 `json:"appfirewallviolcombinedxxeperprofilerate,omitempty"`
	Appfirewallviolcombinedxssperprofile int `json:"appfirewallviolcombinedxssperprofile,omitempty"`
	/**
	* Number of combined Cross-Site Scripting security check violations seen by the Application Firewall.
	*/
	Appfirewallviolcombinedxssperprofilerate float64 `json:"appfirewallviolcombinedxssperprofilerate,omitempty"`
	Appfirewallviolcombinedowaspperprofile int `json:"appfirewallviolcombinedowaspperprofile,omitempty"`
	/**
	* Number of combined OWASP security check violations seen by the Application Firewall.
	*/
	Appfirewallviolcombinedowaspperprofilerate float64 `json:"appfirewallviolcombinedowaspperprofilerate,omitempty"`
	Appfirewallviolcmdgramperprofile int `json:"appfirewallviolcmdgramperprofile,omitempty"`
	/**
	* Number of HTML CMD Injection security check violations (reported by CMD grammar) seen by the Application Firewall.
	*/
	Appfirewallviolcmdgramperprofilerate float64 `json:"appfirewallviolcmdgramperprofilerate,omitempty"`
	Appfirewallvioljsoncmdgramperprofile int `json:"appfirewallvioljsoncmdgramperprofile,omitempty"`
	/**
	* Number of JSON CMD Injection security check violations (reported by CMD grammar) seen by the Application Firewall.
	*/
	Appfirewallvioljsoncmdgramperprofilerate float64 `json:"appfirewallvioljsoncmdgramperprofilerate,omitempty"`
	Appfirewallviolblockkeywordperprofile int `json:"appfirewallviolblockkeywordperprofile,omitempty"`
	/**
	* Number of HTML Block Keyword security check violations seen by the Application Firewall.
	*/
	Appfirewallviolblockkeywordperprofilerate float64 `json:"appfirewallviolblockkeywordperprofilerate,omitempty"`
	Appfirewallvioljsonblockkeywordperprofile int `json:"appfirewallvioljsonblockkeywordperprofile,omitempty"`
	/**
	* Number of JSON Block Keyword security check violations seen by the Application Firewall.
	*/
	Appfirewallvioljsonblockkeywordperprofilerate float64 `json:"appfirewallvioljsonblockkeywordperprofilerate,omitempty"`
	...
	*/
	...
	Appfirewallgrpclogsperprofile int `json:"appfirewallgrpclogsperprofile,omitempty"`
	/**
	* Number of gRPC checks seen by the Application Firewall.
	*/
	Appfirewallgrpclogsperprofilerate float64 `json:"appfirewallgrpclogsperprofilerate,omitempty"`
	...
	*/
	...
	Appfirewalllogcmdgramperprofile int `json:"appfirewalllogcmdgramperprofile,omitempty"`
	/**
	* Number of HTML CMD Injection security check log messages (reported by CMD grammar) generated by the Application Firewall.
	*/
	Appfirewalllogcmdgramperprofilerate float64 `json:"appfirewalllogcmdgramperprofilerate,omitempty"`
	Appfirewalllogsjsoncmdgramperprofile int `json:"appfirewalllogsjsoncmdgramperprofile,omitempty"`
	/**
	* Number of JSON CMD Injection security check log messages (reported by CMD grammar) generated by the Application Firewall.
	*/
	Appfirewalllogsjsoncmdgramperprofilerate float64 `json:"appfirewalllogsjsoncmdgramperprofilerate,omitempty"`
	Appfirewalllogblockkeywordperprofile int `json:"appfirewalllogblockkeywordperprofile,omitempty"`
	/**
	* Number of HTML Block Keyword security check log messages generated by the Application Firewall.
	*/
	Appfirewalllogblockkeywordperprofilerate float64 `json:"appfirewalllogblockkeywordperprofilerate,omitempty"`
	Appfirewalllogjsonblockkeywordperprofile int `json:"appfirewalllogjsonblockkeywordperprofile,omitempty"`
	/**
	* Number of JSON Block Keyword security check log messages generated by the Application Firewall.
	*/
	Appfirewalllogjsonblockkeywordperprofilerate float64 `json:"appfirewalllogjsonblockkeywordperprofilerate,omitempty"`
	...
	*/
	...
	Appfirewallcfgstarturlclosureperprofile int `json:"appfirewallcfgstarturlclosureperprofile,omitempty"`
	Appfirewallcfgcookietransformsperprofile int `json:"appfirewallcfgcookietransformsperprofile,omitempty"`
	Appfirewallcfgcrosssitescriptingtransformunsafehtmlperprofile int `json:"appfirewallcfgcrosssitescriptingtransformunsafehtmlperprofile,omitempty"`
	Appfirewallcfgcrosssitescriptingcheckcompleteurlsperprofile int `json:"appfirewallcfgcrosssitescriptingcheckcompleteurlsperprofile,omitempty"`
	Appfirewallcfgsqlinjectiongrammarperprofile int `json:"appfirewallcfgsqlinjectiongrammarperprofile,omitempty"`
	Appfirewallcfgsqlinjectiontransformspecialcharsperprofile int `json:"appfirewallcfgsqlinjectiontransformspecialcharsperprofile,omitempty"`
	Appfirewallcfgsqlinjectionchecksqlwildcharsperprofile int `json:"appfirewallcfgsqlinjectionchecksqlwildcharsperprofile,omitempty"`
	Appfirewallcfgcreditcardxoutperprofile int `json:"appfirewallcfgcreditcardxoutperprofile,omitempty"`
	Appfirewallcfgdosecurecreditcardloggingperprofile int `json:"appfirewallcfgdosecurecreditcardloggingperprofile,omitempty"`
	Appfirewallcfgstreamingperprofile int `json:"appfirewallcfgstreamingperprofile,omitempty"`
	Appfirewallcfgtraceperprofile int `json:"appfirewallcfgtraceperprofile,omitempty"`
	Appfirewallcfgjsonsqlinjectiongrammarperprofile int `json:"appfirewallcfgjsonsqlinjectiongrammarperprofile,omitempty"`
	Appfirewallcfgxmlsqlinjectionchecksqlwildcharsperprofile int `json:"appfirewallcfgxmlsqlinjectionchecksqlwildcharsperprofile,omitempty"`
	Appfirewallcfgusehtmlerrorobjectperprofile int `json:"appfirewallcfgusehtmlerrorobjectperprofile,omitempty"`
	Appfirewallcfglogeverypolicyhitperprofile int `json:"appfirewallcfglogeverypolicyhitperprofile,omitempty"`
	Appfirewallcfgexemptclosureurlsfromsecuritychecksperprofile int `json:"appfirewallcfgexemptclosureurlsfromsecuritychecksperprofile,omitempty"`
	Appfirewallcfgcanonicalizehtmlresponseperprofile int `json:"appfirewallcfgcanonicalizehtmlresponseperprofile,omitempty"`
	Appfirewallcfgenableformtaggingperprofile int `json:"appfirewallcfgenableformtaggingperprofile,omitempty"`
	Appfirewallcfgsessionlessurlclosureperprofile int `json:"appfirewallcfgsessionlessurlclosureperprofile,omitempty"`
	Appfirewallcfgsemicolonfieldseparatorperprofile int `json:"appfirewallcfgsemicolonfieldseparatorperprofile,omitempty"`
	Appfirewallcfgexcludefileuploadfromchecksperprofile int `json:"appfirewallcfgexcludefileuploadfromchecksperprofile,omitempty"`
	Appfirewallcfgcheckrequestheadersperprofile int `json:"appfirewallcfgcheckrequestheadersperprofile,omitempty"`
	Appfirewallcfgoptimizepartialreqsperprofile int `json:"appfirewallcfgoptimizepartialreqsperprofile,omitempty"`
	Appfirewallcfgurldecoderequestcookiesperprofile int `json:"appfirewallcfgurldecoderequestcookiesperprofile,omitempty"`
	Appfirewallcfgpercentdecoderecursivelyperprofile int `json:"appfirewallcfgpercentdecoderecursivelyperprofile,omitempty"`
	Appfirewallcfginsertcookiesamesiteattributeperprofile int `json:"appfirewallcfginsertcookiesamesiteattributeperprofile,omitempty"`
	Appfirewallcfgfakeaccountdetectionperprofile int `json:"appfirewallcfgfakeaccountdetectionperprofile,omitempty"`
	Appfirewallcfgfieldscanenabledperprofile int `json:"appfirewallcfgfieldscanenabledperprofile,omitempty"`
	Appfirewallcfgfieldscanenabledjsonperprofile int `json:"appfirewallcfgfieldscanenabledjsonperprofile,omitempty"`
	Appfirewallcfgmessagescanenabledperprofile int `json:"appfirewallcfgmessagescanenabledperprofile,omitempty"`
	Appfirewallcfgmessagescanenabledjsonperprofile int `json:"appfirewallcfgmessagescanenabledjsonperprofile,omitempty"`
